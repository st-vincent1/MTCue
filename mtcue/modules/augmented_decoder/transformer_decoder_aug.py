...
from mtcue.modules.augmented_decoder import transformer_layer_aug
...
class AugTransformerDecoderBase(TransformerDecoderBase):
    ...
    def extract_features_scriptable(
        ...
        if len(encoder_out["cxt_encoder_out"]) > 0:
            enc_aug = encoder_out["cxt_encoder_out"][0]
        if len(encoder_out["cxt_encoder_padding_mask"]) > 0:
            padding_mask_aug = encoder_out["cxt_encoder_padding_mask"][0]
